            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9 col-xs-2">
                        <input type="text" class="form-control" placeholder="Enter Patient ID Or Phone Number" name="patient_id_or_number" id="patient_id_or_number" value="<?php echo $appointment_details->patient_id;?>" autocomplete="off" readonly>
                    </div>
                ...
                <?php foreach($categories as $cat){ ?>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                <input type="checkbox" class="form-check-input categories[]" name="categories[]" id="categories[]" value="<?php echo $cat->id;?>"  <?php if(!empty($patient_categories)){foreach($patient_categories as $pt){if($pt->category_id==$cat->id){echo "checked";}}} ?>>
                ...
                <?php } ?>
                <div class="form-group row">
                    <div class="col-sm-2 btn btn-primary text-center m-b-20"><span>Treatment </span></div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-2"></div>
                        <div class="col-sm-10">
                            <textarea class="form-control" name="treatment"  id="treatment" autocomplete="off" readonly></textarea>
                        </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-2 btn btn-primary text-center m-b-20"><span>Medicine </span></div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-2"></div>
                        <div class="col-sm-10">
                            <textarea class="form-control" name="medicine"  id="medicine" autocomplete="off" readonly></textarea>
                        </div>
                </div>
            </form>
        </div>
