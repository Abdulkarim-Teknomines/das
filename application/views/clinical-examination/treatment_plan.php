    ...
    <div class="card-header">
        <div class="card-block">
            <form method="post" enctype="multipart/form-data">
                ...
                <?php } ?>
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label btn btn-primary text-center m-b-20">Previous Treatment Plan History</label>
                </div>
                <div class="form-group row">
                    <?php foreach($treatment_plan as $mh){ ?>
                        <div class="col-sm-2"></div>
                        <div class="col-sm-10">
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                <input type="checkbox" class="form-check-input treatment_plan" name="treatment_plan" id="treatment_plan" value="<?php echo $mh->id;?>" >
                                <label class="form-label"><?php echo $mh->category_name;?></label>
                                </label>
                            </div>
                            <?php $sub_cats = $CI->Patient_model->get_treatment_plan_sub_categories($mh->id);
                                    if(!empty($sub_cats)){ 
                ...
                <!-- <div class="form-group row">
                    ...
                    <div class="col-sm-1 text-right">
                        <input type="button" name="button" class="btn btn-primary text-center m-b-20 previous" value="Previous" autocomplete="off">
                    </div>
        ...
        $.ajax({
            ...
            success: function(data) {
                if(data.patient_details.length<=0){
                    ...
                    if(data.treatment_plan!=null){
                        
                        var res = data.treatment_plan.treatment_plan.split(',');
                        
                        $.each(res,function(key,val){
                            $(".treatment_plan").each(function(){
                                var text = $(this).val();
                                if(text==val){
...
$("#submit").click(function(e){
        ...
        $(".treatment_plan:checked").each(function(){
            var text = $(this).val();
